...
var uiRealm: Realm!
var baseURL = "http://172.18.9.240:3010"
var localTimeZoneId = "America/Fortaleza"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if SessionControl.isSessionActive {
            self.window?.rootViewController = UINavigationController(rootViewController: StoryboardScene.Main.tabBarViewController.instantiate()) 
        } else {
